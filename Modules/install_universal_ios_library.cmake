...
function(install_universal_ios_library destination)
  ...
  string(COMPARE EQUAL "${INSTALL_UNIVERSAL_IOS_LIBRARY_NAME}" "" is_empty)
  if(is_empty)
    message(FATAL_ERROR "INSTALL_UNIVERSAL_IOS_LIBRARY_NAME is empty")
  endif()
  set(target "${INSTALL_UNIVERSAL_IOS_LIBRARY_NAME}")

  string(COMPARE EQUAL "${INSTALL_UNIVERSAL_IOS_LIBRARY_TOP}" "" is_empty)
  if(is_empty)
    message(FATAL_ERROR "INSTALL_UNIVERSAL_IOS_LIBRARY_TOP is empty")
  endif()
  set(work_dir "${INSTALL_UNIVERSAL_IOS_LIBRARY_TOP}")
